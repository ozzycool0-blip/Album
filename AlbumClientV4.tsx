  ...
  useEffect(() => {
    async function loadAlbum() {
      ...
      const { data: selectionsData, error: selectionsError } = await supabase
        .from('selections')
        .select('id, name, description, introduccion, order_index, tenant_id')
                  ...
                  {selectionStickers.map((sticker) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-3 text-sm font-semibold text-slate-900 text-center">
                          {sticker.name}
                        </div>
